...
### Harjoituksissa lähdetään yhdestä hiiren alkion (E13.5) taka-aivojen alueen (rhombomere 1) scRNA sekvensointi näytteen tuloksesta. Sekvensointi data löytyy Puhdista kansiosta /bioinfo/scRNA-seq/. Tavoitteena on piirtää näytteestä solutason hajotelma UMAP algoritmilla sekä katsoa muutamien markkeri geenien ilmentymistä soluissa.

### Hae datapaketti Puhdilta, ja pura zip-tiedosto. Huomioi että siitä syntyy kansiot data/filtered_feature_bc_matrix/ ja sen sisällä on 3 gz-pakettia. ÄLÄ PURA NÄITÄ, R:n monet paketit osaavat lukea suoraan pakattua dataa.
